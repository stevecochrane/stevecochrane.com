...
<html lang="en">
    <head>
        ...
        <meta name="description" content="A web designer and developer from Austin, Texas.">
        ...
        <div class="l-vert-center">
            <div class="l-page">
                ...
                <footer class="l-footer">
                    <p><small>Copyright &copy; 2005 &ndash; <?php echo date("Y"), " " ?> Steve Cochrane. All rights reserved.</small></p>
                </footer>
            </div>
        </div>
